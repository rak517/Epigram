...
export default function LandingHeader({ showIcon = true }: LandingHeaderProps) {
  if (showIcon) {
    return (
      <header className='border-b-line-100 fixed flex w-full items-center justify-between border-b-[1px] px-6 py-2 md:h-[80px] md:py-3 xl:px-[72px] xl:px-[120px] xl:py-4'>
        <Link href={'/search'}>
  ...
  return (
    <header className='items-between border-b-line-100 fixed flex w-full justify-center border-b-[1px] py-[13px] xl:h-[80px]'>
